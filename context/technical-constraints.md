...
| Karar | Seçim | Gerekçe |
|-------|-------|---------|
| Framework | React Native | Tek kod tabanıyla iOS + Android, TypeScript desteği |
...
*Bu kısıtlamalar proje boyunca tüm ajanlar tarafından uygulanır. Değişiklik için Team Lead onayı ve karar kaydı (ADR) gereklidir.*
