...
class PDFUtils {
    static generateVolunteerReport(res, data) {
    ...
    static generateCertificate(res, userData, stats) {
        ...
        doc
            .fontSize(16)
            .fillColor('#333333')
            .text(`LÖSEV İnci Portalı aracılığıyla gerçekleştirdiğiniz ${stats.totalHours} saatlik değerli gönüllü katkılarınız ve toplumda yarattığınız fark için teşekkür eder, başarılarınızın devamını dileriz.`, 100, doc.y, { align: 'center', width: doc.page.width - 200, lineGap: 5 })
            .moveDown(2);
